...
const SearchBar = () => {
  return (
    <div className='search-bar-container font-oxanium'>
      <Form method='post' className='flex mt-20' action='/search'>
        <input
          type='text'
          className='bg-white py-2  px-4 placeholder-shown .placeholder-gray-200  text-gray-500 w-70'
        ...
        <button
          className='bg-orange-500  text-white font-bold py-2 px-4 hover:bg-orange-500/94 cursor-pointer'
          style={{
